...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-3 sm:p-4 w-full max-w-[100vw] overflow-x-hidden box-border">
      <div className="bg-white p-5 sm:p-6 md:p-8 rounded-lg shadow-lg w-full max-w-lg">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center text-gray-800 mb-5 sm:mb-6">ثبت نام کاربر جدید</h2>
